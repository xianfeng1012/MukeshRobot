...
Mukesh = [
    [
        InlineKeyboardButton(text="主人", user_id=OWNER_ID),
        InlineKeyboardButton(text="支持群", url=f"https://t.me/{SUPPORT_CHAT}"),
    ],
    [
...
async def restart(client, m: Message):
    ...
    await m.reply_photo(
        START_IMG,
        caption=f"""**你好，我是 『[{BOT_NAME}](f"t.me/{BOT_USERNAME}")』**
   ━━━━━━━━━━━━━━━━━━━
  » **我的主人：** {owner.mention()}
